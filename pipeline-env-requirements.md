...
1) Create a GitHub Repository name `Jenkins-CICD-Pipeline-Project` and push the code in this branch(main) to 
    ...
    - Download the code in in this repository "Main branch": https://github.com/inyeguh/devops-cicd-project.git
...
2) Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/inyeguh/devops-cicd-project/blob/maven-nexus-sonarqube-jenkins-install/jenkins-install.sh
    - Launch Instance
...
3) SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/inyeguh/devops-cicd-project/blob/maven-nexus-sonarqube-jenkins-install/sonarqube-install.sh
    - Launch Instance
...
4) Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/inyeguh/devops-cicd-project/blob/maven-nexus-sonarqube-jenkins-install/nexus-install.sh
    - Launch Instance
...
8) Slack 
    ...
    - Use one of the links below to join slack
    - Link: https://join.slack.com/t/jjtech-eagles-cicd/shared_invite/zt-1go3k7pz7-uSy3D4ai3Pb7KJk2G1sc1g 
    - Link: https://join.slack.com/t/devopsfullyau-r0x2686/shared_invite/zt-1nzxt7e9z-ChDASWBOysUpa3tH5gi95A

9) Configure Promitheus
    - Login/SSH to your Prometheus Server
    - Clone the following repository: https://github.com/inyeguh/devops-cicd-project.git
