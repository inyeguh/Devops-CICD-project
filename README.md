...
- https://github.com/inyeguh/devops-cicd-project/blob/maven-nexus-install/nexus-install.sh

## Install Apache Maven
- https://github.com/inyeguh/devops-cicd-project/blob/maven-nexus-install/maven-install.md
